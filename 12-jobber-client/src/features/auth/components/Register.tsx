...
import type { IModalBgProps } from "src/shared/modals/interfaces/modal.interface";
...
const RegisterModal: FC<IModalBgProps> = ({ onClose, onToggle }): ReactElement => {
  ...
  const isError = (key: string) => validationErrors.some((obj: validationErrorsType) => Object.keys(obj).includes(key));
          ...
          <div className="relative px-5 py-5">
            <div>
              ...
              <TextInput
                ...
                className={`mb-5 mt-2 flex h-10 w-full items-center rounded border border-gray-300 pl-3 text-sm font-normal text-gray-600 focus:border focus:border-sky-500/50 focus:outline-none ${isError("username") ? "border-red-500" : ""}`}
            ...
            <div>
              ...
              <TextInput
                ...
                className={`mb-5 mt-2 flex h-10 w-full items-center rounded border border-gray-300 pl-3 text-sm font-normal text-gray-600 focus:border focus:border-sky-500/50 focus:outline-none ${isError("email") ? "border-red-500" : ""}`}
            ...
            <div>
              ...
              <div className="relative mb-5 mt-2">
                ...
                <TextInput
                  ...
                  className={`flex h-10 w-full items-center rounded border border-gray-300 pl-3 text-sm font-normal text-gray-600 focus:border focus:border-sky-500/50 focus:outline-none ${isError("password") ? "border-red-500" : ""}`}
