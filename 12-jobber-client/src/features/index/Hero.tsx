import { ChangeEvent, type FC, FormEvent, type ReactElement, type RefObject, useEffect, useRef, useState } from "react";
...
const Hero: FC = (): ReactElement => {
  ...
  // allows you to hit enter on keyboard
        ...
        <div className="lg:flex">
          <div className="relative mt-8 space-y-8 text-center sm:mx-auto sm:w-10/12 md:mt-16 md:w-2/3 lg:ml-0 lg:mr-auto lg:w-7/12 lg:text-left">
            ...
            <div className="flex w-full justify-between gap-6 lg:gap-12">
              <form className="mx-auto flex w-full items-center bg-white" onSubmit={handleSubmit}>
