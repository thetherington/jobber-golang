...
import type { IModalProps } from "src/shared/modals/interfaces/modal.interface";

import { useCountDown } from "../hooks/useCountDown";
import type { IOrderDisplayModal, IOrderDocument } from "../interfaces/order.interface";
        ...
        {authUser?.username === order?.sellerUsername && (
          <div className="flex w-full cursor-pointer flex-col gap-4">
            <Button
              ...
              onClick={() => setDisplayModal({ ...displayModal, deliverWork: true })}
            />
            {!order?.delivered && (
              <div
