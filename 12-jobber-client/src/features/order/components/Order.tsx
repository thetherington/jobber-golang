import { type FC, MutableRefObject, type ReactElement, useEffect, useRef, useState } from "react";
...
const Order: FC = (): ReactElement => {
  ...
  useEffect(() => {
    ...
    if (orderDocument.orderId === orderId) {
                ...
                <ul className="mb-0 list-none">
                  ...
                  <li className="flex justify-between px-4 pb-2 pt-2">
                    ...
                    <span className="text-sm font-bold">
                      {order?.offer?.newDeliveryDate ? TimeAgo.dayMonthYear(`${order?.offer?.newDeliveryDate}`) : ""}
                    </span>
                  </li>
