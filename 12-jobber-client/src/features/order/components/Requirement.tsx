...
import { ChangeEvent, type FC, type ReactElement, useRef, useState } from "react";
...
import type { IOffer, IOrderDocument, IOrderInvoice } from "../interfaces/order.interface";
