...
import { type FC, type FormEvent, type ReactElement, useEffect, useState } from "react";
import { createSearchParams } from "react-router-dom";
import Button from "src/shared/button/Button";

import type { ICheckoutProps } from "../../interfaces/order.interface";
...
const CheckoutForm: FC<ICheckoutProps> = ({ gigId, offer }): ReactElement => {
  const [isStipeLoading, setIsStipeLoading] = useState<boolean>(true);
  ...
  return (
    <form id="payment-form" onSubmit={handleSubmit}>
      {isStipeLoading && <CheckoutFormSkeleton />}
      <PaymentElement id="payment-element" onReady={() => setIsStipeLoading(false)} />
      <Button
        id="subnet"
