...
import type { IOrderReviewModal } from "src/features/order/interfaces/order.interface";
...
const OrderReview: FC = (): ReactElement => {
  ...
  return (
    <>
      ...
      {order?.approved && authUser?.username === order.buyerUsername && !order.buyerReview && (
