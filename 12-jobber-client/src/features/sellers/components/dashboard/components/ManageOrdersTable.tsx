...
import type { IOrderDocument, IOrderMessage, IOrderTableProps } from "src/features/order/interfaces/order.interface";
              ...
              <thead className="border-grey border-b text-xs uppercase text-gray-700 sm:[&>*:not(:first-child)]:hidden">
                {orders.map(() => (
                  ...
                  >
                    ...
                    <th className="p3 text-center">Total</th>
                    <th className="p3 text-center">Status</th>
