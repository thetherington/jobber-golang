...
import type { IGigInfo } from "src/features/gigs/interfaces/gig.interface";
import type { IProfileHeaderProps, ISellerProfileItem, IShowEditItem } from "src/features/sellers/interfaces/seller.interface";
