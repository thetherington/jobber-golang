...
import { useSeller } from "src/features/sellers/context/SellerContext";
import type { ILanguage, ILanguageEditFieldsProps } from "src/features/sellers/interfaces/seller.interface";
...
const LanguageFields: FC<ILanguageEditFieldsProps> = ({
  ...
  const { sellerProfile, setSellerProfile } = useSeller();
