...
import type { IGigsProps, ISellerGig } from "src/features/gigs/interfaces/gig.interface";
...
import type { IApprovalModalContent } from "../modals/interfaces/modal.interface";
    ...
    <>
      ...
      <div className="relative">
        {gigCardItemModal.overlay && (
          <div className="border-grey absolute bottom-0 top-0 mb-8 w-full cursor-pointer border bg-white/95">
            <div
