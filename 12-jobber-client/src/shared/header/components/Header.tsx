import { type FC, lazy, type LazyExoticComponent, type ReactElement, Suspense, useState } from "react";
import { FaBars, FaTimes } from "react-icons/fa";
import { Link } from "react-router-dom";
import type { IHeader, IHeaderModalProps } from "src/shared/header/interfaces/header.interface";
import type { IModalBgProps } from "src/shared/modals/interfaces/modal.interface";
import type { IButtonProps } from "src/shared/shared.interface";
...
const LoginModal: LazyExoticComponent<FC<IModalBgProps>> = lazy(() => import("src/features/auth/components/Login"));
const RegisterModal: LazyExoticComponent<FC<IModalBgProps>> = lazy(() => import("src/features/auth/components/Register"));
const ForgotPasswordModal: LazyExoticComponent<FC<IModalBgProps>> = lazy(() => import("src/features/auth/components/ForgotPassword"));
