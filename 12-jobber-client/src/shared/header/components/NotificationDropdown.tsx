...
const NotificationDropdown: FC<IHomeHeaderProps> = ({ setIsOrderDropdownOpen }): ReactElement => {
  ...
  const markNotificationAsRead = async (notificationId: string): Promise<void> => {
    try {
      ...
      showErrorToast("Error marking message as read");
    }
  };
