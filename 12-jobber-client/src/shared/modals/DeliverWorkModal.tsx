import { type ChangeEvent, type FC, type ReactElement, useRef, useState } from "react";
import { FaCircleNotch, FaPaperclip, FaRegFile, FaTimes } from "react-icons/fa";
import type { IDeliveredWork } from "src/features/order/interfaces/order.interface";
          ...
          <div className="relative bottom-auto left-auto right-auto top-auto max-h-[90vh] min-w-[500px] bg-white p-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                className={`cursor-pointer rounded px-6 py-3 text-center text-sm font-bold text-white focus:outline-none md:px-4 md:py-2 md:text-base ${!description || !selectedFile ? "cursor-not-allowed bg-sky-200" : "bg-sky-500 hover:bg-sky-400"}`}
                label="Deliver"
                onClick={deliverWork}
              />
            </div>
